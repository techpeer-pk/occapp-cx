    ...
    <div className="flex h-screen bg-gray-50">
      ...
      `}>
        <div className="p-4 border-b border-gray-700 flex items-center gap-3">
          <div className="w-8 h-8 bg-brand rounded-lg flex items-center justify-center font-bold text-sm">B</div>
          <div>
            <p className="font-semibold text-sm">ARY Cash Portal</p>
            <p className="text-xs text-gray-400">BDO Panel</p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3 lg:hidden">
          ...
          <span className="font-semibold text-gray-800">BDO Panel</span>
        </header>
